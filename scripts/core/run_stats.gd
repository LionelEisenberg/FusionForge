...
## Collision counts. x: Wall hits, y: Element hits, z: Fusions
@export var collision_counts: Vector3i = Vector3i.ZERO
...
func get_total_collisions() -> int:
	return collision_counts.x + collision_counts.y + collision_counts.z
...
func _to_string() -> String:
	...
	var fusion_collisions_str: String = "  Fusion Collisions: %d" % collision_counts.z
